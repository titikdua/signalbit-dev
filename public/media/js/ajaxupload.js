...
var html_error_http='<img src="' + domain_data + 'public/media/admin-images/error.gif" width=\'16\' height=\'16\' border=\'0\' /> Error in Upload, check settings and path info in source code.';
	...
	form.submit();
	setTimeout("xmlhttpPost('/SignalBit - HR/admin/thememanager/refreshlogoajax','1' ,'logoimage')",1000);
	setTimeout("xmlhttpPost('/SignalBit - HR/admin/thememanager/refreshuploadedlogosajax','1' ,'uploadedImages')",1200);
