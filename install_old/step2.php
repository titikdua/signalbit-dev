...
function writeDBconstants($hostname,$username,$password,$dbname)
{
		...
		{
			$db_content = "<?php
	           defined('CAMHRMS_HOST') || define('CAMHRMS_HOST','".$hostname."');
	           defined('CAMHRMS_USERNAME') || define('CAMHRMS_USERNAME','".$username."');
	           defined('CAMHRMS_PASSWORD') || define('CAMHRMS_PASSWORD','".$password."');
	           defined('CAMHRMS_DBNAME') || define('CAMHRMS_DBNAME','".$dbname."');
           ...
           <span  class="error_info"><?php echo isset($msgarray['error'])?$msgarray['error']:'';?></span>
		    <div class="new-form-ui ">
			  <label class="required">Host<img src="images/help.png" title="IP address of your hosting account as your MySQL hostname." class="tooltip"></label>
				<div >
					<input type="text" maxlength="40" value="<?php if(!$_POST){ echo defined('CAMHRMS_HOST')?CAMHRMS_HOST:''; } else {echo $_POST['host']; }?>" id="host" name="host">
			...
			<div class="new-form-ui ">
			  <label class="required">User Name<img src="images/help.png" title="Database Server username provided during MySQL account setup." class="tooltip"></label>
				<div>
					<input type="text" maxlength="50" value="<?php if(!$_POST){ echo defined('CAMHRMS_USERNAME')?CAMHRMS_USERNAME:''; } else {echo $_POST['username']; }?>" id="username" name="username">
			...
			<div class="new-form-ui ">
			  <label >Password<img src="images/help.png" title="Database Server password provided during MySQL account setup." class="tooltip"></label>
				<div>
					<input type="password" maxlength="50" value="<?php if(!$_POST){ echo defined('CAMHRMS_PASSWORD')?CAMHRMS_PASSWORD:''; } else {echo $_POST['password']; }?>" id="password" name="password">
			...
			<div class="new-form-ui ">
			  <label class="required">Database Name<img src="images/help.png" title="Create a database and provide the name of the database here." class="tooltip"></label>
				<div>
					<input type="text" maxlength="50" value="<?php if(!$_POST){ echo defined('CAMHRMS_DBNAME')?CAMHRMS_DBNAME:'';} else {echo $_POST['dbname']; }?>" id="dbname" name="dbname">
...
<script type="text/javascript">
		$(document).ready(function(){
			...
			<?php if(defined('CAMHRMS_HOST') && defined('CAMHRMS_USERNAME') && defined('CAMHRMS_PASSWORD') && defined('CAMHRMS_DBNAME') && defined('APPLICATION_NAME') && defined('SUPERADMIN_EMAIL') && defined('MAIL_SMTP') && defined('MAIL_USERNAME') && defined('MAIL_PASSWORD') && defined('MAIL_PORT') && defined('MAIL_AUTH') && defined('MAIL_TLS')){ ?>
