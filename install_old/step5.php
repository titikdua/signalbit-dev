...
<?php 
if(defined('CAMHRMS_HOST') && defined('CAMHRMS_USERNAME') && defined('CAMHRMS_PASSWORD') && defined('CAMHRMS_DBNAME') && defined('APPLICATION_NAME') && defined('SUPERADMIN_EMAIL') && defined('MAIL_SMTP') && defined('MAIL_USERNAME') && defined('MAIL_PASSWORD') && defined('MAIL_PORT') && defined('MAIL_TLS') && defined('MAIL_AUTH'))
{ ?>
...
?>        
    ...
    <div>
    <li><span class="info">Host:</span><span class="infotext"><?php echo CAMHRMS_HOST;?></span></li>
    <li><span class="info">Username:</span><span class="infotext"><?php echo CAMHRMS_USERNAME;?></span></li>
    <li><span class="info">Password:</span><span class="infotext"><?php echo CAMHRMS_PASSWORD;?></span></li>
    <li><span class="info">Database:</span><span class="infotext"><?php echo CAMHRMS_DBNAME;?></span></li>
    </div>
...
?>        
     ...
     <?php 
	$password = '--';
		if (defined('CAMHRMS_PASSWORD')) {
			if (CAMHRMS_PASSWORD) {
				$password = CAMHRMS_PASSWORD;
			}
		}
	?>       
    ...
    <div>
    <li  style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;"><span>Host: </span><span><?php echo CAMHRMS_HOST;?></span></li>
    <li  style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;"><span>User name: </span><span><?php echo CAMHRMS_USERNAME;?></span></li>
    ...
    <li  style="border-bottom: 1px solid rgb(204, 204, 204); margin: 0px; padding: 10px 5px 10px 15px;"><span>Database: </span><span><?php echo CAMHRMS_DBNAME;?></span></li>
    </div>
    ...
    <input type="hidden" id="dbhost" name="dbhost" value="<?php echo CAMHRMS_HOST;?>" />
    <input type="hidden" id="dbusername" name="dbusername" value="<?php echo CAMHRMS_USERNAME;?>" />
    <input type="hidden" id="dbpassword" name="dbpassword" value="<?php echo CAMHRMS_PASSWORD;?>" />
    <input type="hidden" id="dbname" name="dbname" value="<?php echo CAMHRMS_DBNAME;?>" />
...
<script type="text/javascript">
		$(document).ready(function(){
			...
			<?php if(defined('CAMHRMS_HOST') && defined('CAMHRMS_USERNAME') && defined('CAMHRMS_PASSWORD') && defined('CAMHRMS_DBNAME')){ ?>
			...
			<?php if(defined('CAMHRMS_HOST') && defined('CAMHRMS_USERNAME') && defined('CAMHRMS_PASSWORD') && defined('CAMHRMS_DBNAME') && defined('APPLICATION_NAME') && defined('SUPERADMIN_EMAIL') && defined('MAIL_SMTP') && defined('MAIL_USERNAME') && defined('MAIL_PASSWORD') && defined('MAIL_PORT') && defined('MAIL_TLS')){ ?>
