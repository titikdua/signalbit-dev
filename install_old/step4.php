...
function mail_send($tls,$smtpserver,$username,$password,$port,$auth)
{
	...
	<div style="width:100%;">
            ...
            <div><img src="../public/media/images/camhrms-email_wizard.png" height="62" width="319" /></div>
...
<script type="text/javascript">
		$(document).ready(function(){
			...
			<?php if(defined('CAMHRMS_HOST') && defined('CAMHRMS_USERNAME') && defined('CAMHRMS_PASSWORD') && defined('CAMHRMS_DBNAME') && defined('APPLICATION_NAME') && defined('SUPERADMIN_EMAIL') && defined('MAIL_SMTP') && defined('MAIL_USERNAME') && defined('MAIL_PASSWORD') && defined('MAIL_PORT') && defined('MAIL_TLS') && defined('MAIL_AUTH')){ ?>
